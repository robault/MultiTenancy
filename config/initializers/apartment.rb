...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{ Home Tenant User }
  # TODO: Notice how we have to add models to the excluded list for them to be considered global.
  # In this code the Message and Project models are not here and they are in fact tenanted.
...
# If you want to exclude a domain, for example if you don't want your application to treat www
# like a subdomain, you can set the following:
